...
export const ar: Translation = {
	...
	headerExtra: {
		...
		wipItem4: 'المزيد من الخرائط ومحتوى الحقبة الثانية (ربما؟)',
	...
	about: {
		...
		communityTranslationsDesc: 'بيانات الترجمة والخرائط المترجمة مقدمة من المجتمع. شكراً لكم!',
	...
	welcome: {
		...
		enableButton: 'تفعيل وضع القراءة المصاحبة',
		skipButton: 'لا شكرًا، أظهر كل شيء',
		hint: 'يمكنك دائمًا تغيير هذا من قائمة التحكم على اليسار.',
	},
