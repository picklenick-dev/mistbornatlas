...
export const pt: Translation = {
	...
	about: {
		...
		communityTranslationsTitle: 'Traduções da Comunidade',
		communityTranslationsDesc:
			'Dados de tradução e mapas localizados contribuídos pela comunidade. Obrigado!',
		...
		translationNote:
			'As traduções são geradas por IA e ainda não foram revisadas por falantes nativos.',
	},
