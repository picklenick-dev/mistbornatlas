...
export const sv: Translation = {
	...
	about: {
		...
		communityTranslationsTitle: 'Gemenskapsöversättningar',
		communityTranslationsDesc:
			'Översättningsdata och lokaliserade kartor har bidragits av gemenskapen. Tack!',
		...
		roadmapCompleteTag: 'KLAR',
		roadmap070: 'Det Sista Imperiet — tidslinje klar',
	...
	welcome: {
		...
		description:
			'Läser du Mistborn-trilogin just nu? Aktivera medläsningsläget för att utforska kartan utan spoilers.',
		...
		featureSummaries:
			'Detaljerade sammanfattningar förblir dolda tills du trycker för att visa dem',
